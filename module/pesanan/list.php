<?php
    ...
    if($level == "superadmin") {
        ...
        $queryPesanan = mysqli_query($koneksi, "SELECT pesanan.*, pesanan.status as status_pesanan, user.nama FROM pesanan JOIN user ON pesanan.user_id = user.user_id WHERE pesanan.user_id = '$user_id' ORDER BY pesanan.tanggal_pemesanan DESC");
    }
