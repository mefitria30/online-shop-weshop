...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 21, 2024 at 08:46 AM
...
(16, 9, 'jdbjvbsdbjvbsm', '<p>dsjvbjebjv j,sndvvjdjkvmn ,<strong>dnKSVN K</strong></p>', '3.jpg', 1999, 12, 'on');
...
(4, 2, '08888888', 'Fitria', '2024-01-13'),
(5, 9, '9999', 'oooo', '2024-01-13'),
(6, 9, 'th', 'dbd', '2024-01-13');
...
(5, 3, 7, 'Fitria', '081111111', 'Jl. Panongan', '2024-01-01 07:21:23', 0),
(6, 1, 7, 'test', '44333', 'test xx', '2024-01-01 07:23:50', 0),
(7, 1, 8, 'test1', '598765', 'Jakarta', '2024-01-13 16:03:05', 1),
(8, 2, 8, 'test', '878876', 'Bandung', '2024-01-13 16:18:20', 0),
(9, 1, 8, 'ooo', '88888', 'Jakarta', '2024-01-13 16:48:27', 2),
(10, 1, 8, 'test', '08989', 'Jaksel', '2024-01-20 01:55:18', 0);
...
(7, 'superadmin', 'Timmy John', 'timmy.john@gmail.com', 'Tangerang', '0812828282828', '827ccb0eea8a706c4c34a16891f84e7b', 'on'),
(8, 'customer', 'test1', 'test1@gmail.com', 'Jakarta', '08186254567', '827ccb0eea8a706c4c34a16891f84e7b', 'on');
...
--
ALTER TABLE `pesanan`
  MODIFY `pesanan_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
