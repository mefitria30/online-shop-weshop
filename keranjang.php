    ...
    if($totalBarang == 0) {
        ...
        foreach ($keranjang as $key => $value) {
            ...
            echo "<tr>
                ...
                <td class='tengah'>
                    <input type='number' name='$barang_id' value='$quantity' class='update-quantity' />
                </td>
                <td class='kanan'>".rupiah($harga)."</td>
                <td class='kanan hapus_item'>
                    ".rupiah($total)."
                    <a href='".BASE_URL."hapus_item.php?barang_id=$barang_id'> x </a>
                </td>
            </tr>";
    ...
    $.ajax({
        ...
        .done(function(data) {
            ...
            if (json.status == true) {
                ...
                // alert(json.pesan);
                // setTimeout(json.pesan, 3000);
                // setTimeout(alert(json.pesan), 5000);
